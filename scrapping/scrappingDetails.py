...
tab_url_pays = [
    ("https://fr.trustpilot.com/review/www.wonderbox.fr", "France"),
...
print('il Faut en moyenne 10 min pour scrapper les donnees')
...
for url, pays in tab_url_pays:
    ...
    try:
        ...
        for i in range(1, lastPage):
            if i % frequence == 0:
                print(f"scrapping de {frequence} entrerprises atteint")
